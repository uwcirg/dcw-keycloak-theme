        ...
        <div id="kc-content-wrapper">
          ...
          <#if displayMessage && message?has_content && (message.type != 'warning' || !isAppInitiatedAction??)>
              <div class="alert alert-${message.type}">
                  ...
                  <#--  instance specific login info message  -->
                  <#if message.type = 'error' && properties.loginInfoMessage?has_content>
                    <div class="alert-error">${properties.loginInfoMessage}</div>
                  </#if>
              </div>
          </#if>
